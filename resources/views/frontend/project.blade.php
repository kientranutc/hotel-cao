...
@section('title',trans('home.menu.project'))
@section('meta_keyword', trans('home.menu.project'))
@section('meta_description',trans('home.menu.project'))
@section('meta_author',trans('home.menu.project'))
